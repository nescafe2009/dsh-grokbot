...
export const TOKENS = {
  color: {
    ...
    noticeCard: '#eeeeee',    // 系统通知卡 (238,238,238)
    taskHead: '#282828',      // 任务卡标题条 (40,40,40)
    taskBody: '#141414',      // 任务卡体 (20,20,20)
    badgeDone: '#607d8b',     // 已完成徽章 (96,125,139)
    badgeRunning: '#e67e22',  // 运行/等待徽章 (230,126,34)
    badgeInfo: '#38bcf8',     // 信息/链接徽章 (56,189,248)
    dotDone: '#409050',       // 成员状态点·绿 (64,144,80)
    dotFail: '#b03030',       // 成员状态点·红 (176,48,48)
  ...
  layout: {
    sidebarWidth: 280,        // pt；窄窗 ~302 不按比例缩
  ...
  radius: {
    ...
    taskCard: 12,             // [est] 视觉估读 10–16pt
    composer: 22,             // 胶囊
    noticeCard: 12,
  },
  size: {
    avatarRow: 30,            // 侧栏头像直径 28–30pt
    rowHeight: 56,            // 行距 48–62pt 区间取中
    sendBtn: 22,              // 黑色圆发送钮直径
